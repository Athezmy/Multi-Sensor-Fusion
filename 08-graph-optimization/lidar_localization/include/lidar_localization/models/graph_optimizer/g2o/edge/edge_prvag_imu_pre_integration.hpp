...
public:
	...
	virtual void computeError() override {
		...
		if (v0->isUpdated()) 
		{
			Eigen::Vector3d upd_b_a_i = Eigen::Vector3d::Zero();
			Eigen::Vector3d upd_b_g_i = Eigen::Vector3d::Zero();
			v0->getDeltaBiases(upd_b_a_i, upd_b_g_i);
			updateMeasurement(upd_b_a_i, upd_b_g_i);
		}
