...
#include "imu_integration/global_defination/global_defination.h"
...
bool Activity::UpdatePose(void) {
    if (!initialized_) {
        ...
        */
        ...
        // get deltas:
        Eigen::Vector3d angular_delta;
        GetAngularDelta_Euler(1, 0, angular_delta);
        ...
        Eigen::Vector3d velocity_delta;
        double delta_t;
        GetVelocityDelta_Euler(1, 0,  R_prev, delta_t, velocity_delta);
...
bool Activity::GetAngularDelta_Euler(
    const size_t index_curr, const size_t index_prev,
    Eigen::Vector3d &angular_delta
) {
    //
...
bool Activity::GetVelocityDelta_Euler(
    const size_t index_curr, const size_t index_prev,
