...
bool DataPretreatFlow::InitGNSS() {
    ...
    if (!gnss_inited) {
        ...
        for(int i = 0; i < 5; i++){
        std::cout << "gnss init pose:\n " << gnss_data.latitude << " " << gnss_data.longitude << " " << gnss_data.altitude << " "
        << gnss_data.local_E << " " << gnss_data.local_N << " " << gnss_data.local_U << std::endl; 
        }
...
bool DataPretreatFlow::TransformData() {
    ...
    " local_E: "<<  current_gnss_data_.local_E << "  local_N: " << current_gnss_data_.local_N << "  local_U: " << current_gnss_data_.local_U <<std::endl;
