...
void GNSSData::UpdateXYZ() {
    ...
    geo_converter.Forward(latitude_init, longitude_init, altitude_init, local_E_init, local_N_init, local_U_init);

    
    local_E -= local_E_init;
    local_N -= local_N_init;
    local_U -= local_U_init;

    std::cout << "UpdateXYZ():\n " <<  "latitude_init: " << latitude_init << "  longitude_init: " << longitude_init << " altitude_init: " << altitude_init <<
    " local_E_init: "<<  local_E_init << "  local_N_init: " << local_N_init << "  local_U_init: " << local_U_init << std::endl;

    std::cout << "UpdateXYZ():\n " <<  "latitude: " << latitude << "  longitude: " << longitude << " altitude: " << altitude <<
    " local_E: "<<  local_E << "  local_N: " << local_N << "  local_U: " << local_U << std::endl;
