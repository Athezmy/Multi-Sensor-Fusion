...
class GNSSData {
  public:
    ...
    //0s
    double latitude_init =  48.9827;
    double longitude_init =  8.39045;
    double altitude_init = 116.396;
    
    double local_E_init = 0.0;
    double local_N_init = 0.0;
    double local_U_init = 0.0;
